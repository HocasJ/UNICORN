...
from data.data_manager import process_query_sysu, process_gallery_sysu, process_query_part1_10, process_gallery_part1_10
    ...
    for epoch in range(1, args.stage1_maxepochs+1):
        ...
        if epoch == args.stage1_maxepochs:
            if args.dataset == 'sysu':
                ...
                torch.save(state, os.path.join(args.model_path, args.logs_file + "_dim2048_stage1.pth"))
                ...
                if os.path.exists(args.model_path) is False:
                    os.mkdir(args.model_path)
                torch.save(state, os.path.join(args.model_path, args.logs_file + "0302_stage1.pth"))
